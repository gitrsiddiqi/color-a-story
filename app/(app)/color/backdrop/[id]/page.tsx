...
export default function ColorBackdropDetailPage() {
  ...
  if (!page) {
    return <div className="text-center py-20 text-2xl text-gray-400">Backdrop not found 😢</div>
  }
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <ColoringCanvas
        ...
        isBackdrop
        onSave={handleSave}
        onCancel={() => router.push(returnTo ?? '/color/backdrop')}
      />
    </div>
  )
}
